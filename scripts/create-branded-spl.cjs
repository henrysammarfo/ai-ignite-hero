...
const { createMint, getMinimumBalanceForRentExemption, MINT_SIZE, TOKEN_PROGRAM_ID, createInitializeMintInstruction } = require("@solana/spl-token");
const { createCreateMetadataAccountV3Instruction } = require("@metaplex-foundation/mpl-token-metadata");
const bs58 = require("bs58");
require("dotenv").config();

async function main() {
    console.log("Creating Branded Standard SPL Token (For Solscan Visibility)...");
