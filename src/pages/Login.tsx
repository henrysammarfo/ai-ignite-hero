...
const Login = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    // Placeholder — teammates will wire up real auth
    navigate("/dashboard");
  };
          ...
          <CardContent className="px-6 pb-6">
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              {!isSignUp && (
                <div className="text-right">
                  <button type="button" className="text-xs text-primary font-sans hover:underline">
                    Forgot password?
                  </button>
                </div>
              )}
            ...
            <div className="mt-6">
              ...
              <div className="mt-4 grid grid-cols-2 gap-3">
                <Button variant="outline" className="font-sans text-sm gap-2" type="button">
